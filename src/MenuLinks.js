const MenuLinks = () => {
    return (  
        ...
        <div className="menuLinks">
            <a href="https://twitter.com/bolaji_damola" target="_blank" id="twitter">Twitter Link</a>
            <a href="https://training.zuri.team/" target="_blank" id="btn__zuri">Zuri Team</a>
            <a href="http://books.zuri.team" title="Find books about design and coding" target="_blank" id="books">Zuri Books</a>
